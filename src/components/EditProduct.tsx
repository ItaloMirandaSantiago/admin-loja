...
const EditProduct = ()=>{
    ...
    return(
        <div className="flex justify-center items-center h-screen w-screen fixed top-3">
            <div className="absolute w-3/4 h-full bg-slate-400 rounded flex flex-col justify-center items-center">
                ...
                <form className="text-white w-3/4">
                    ...
                    <button onClick={()=>{put(); setLoading(true)}} type="button" className="py-2 px-3 bg-green-600 hover:bg-green-700 rounded mr-2 ">Concluir</button>
                    <button onClick={()=>Edit?.setEditResApi(null)} className="py-2 mt-3 px-3 bg-red-600 hover:bg-slate-600 rounded">Voltar</button>
                </form>
